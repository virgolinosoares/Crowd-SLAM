        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    cout << endl <<
    "Crowd-SLAM Copyright (C) 2020 Joao Carlos Virgolino Soares, Pontifical Catholic University of Rio de Janeiro." << endl << endl;
    ...
    mptDetector = new thread(&ORB_SLAM2::Detector::Run,mpDetector);
...
cv::Mat System::TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp)
{
	...
	//send RGB image for the detection thread
